...
--
-- Table structure for table `detailesordenes`
--

DROP TABLE IF EXISTS `detailesordenes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `detailesordenes` (
...
--
-- Dumping data for table `detailesordenes`
--

LOCK TABLES `detailesordenes` WRITE;
/*!40000 ALTER TABLE `detailesordenes` DISABLE KEYS */;
/*!40000 ALTER TABLE `detailesordenes` ENABLE KEYS */;
UNLOCK TABLES;
